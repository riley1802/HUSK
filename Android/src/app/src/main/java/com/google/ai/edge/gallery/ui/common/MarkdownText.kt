...
fun MarkdownText(
	...
	val fontSize = baseFontSize * fontSizeScale
	val codeBaseFontSize = MaterialTheme.typography.bodySmall.fontSize * fontSizeScale
					...
					RichTextStyle(
						codeBlockStyle =
							CodeBlockStyle(
								textStyle =
									TextStyle(
										fontSize = codeBaseFontSize,
										fontFamily = FontFamily.Monospace,
										lineHeight = codeBaseFontSize * 1.4f,
									)
							),
						stringStyle =
